...
export default function StoreTile(props) {
  const src =
    process.env.NODE_ENV !== "development"
      ? `${imageBaseURL}/${props.image_url}/full/843,/0/default.jpg`
      : "/home/mfortunato/AF/art-flex-website/public/MainLogo.svg";
  return (
    <StyledTile square elevation={4}>
      <div>
        ...
        <div style={{ maxWidth: props.image_size.width + 50 }}>
          ...
          <div>
            <Typography variant="h5">{props.artist_name}</Typography>
          </div>
